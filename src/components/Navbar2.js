        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">KHAANAAAA.com</Link>
...
//   }
//   return (
//     <nav className="navbar navbar-expand-lg navbar-light bg-success" style={{ backgroundColor: "green" }}>
//       <div className="container-fluid">
//         <Link className="navbar-brand fs-2 fst-italic" to="#">Khana.com</Link>
